...
```js
const WHATSAPP = '50760060073';   // +507 6006-0073
...
Fotografías de [Unsplash](https://unsplash.com) y [Pexels](https://pexels.com),
bajo licencias de uso libre que permiten el uso comercial.
